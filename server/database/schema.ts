...
export const blocks = pgTable('blocks', {
  ...
  timestamp: bigint('timestamp', { mode: 'number' }, { mode: "number" }).notNull(),
  nonce: bigint('nonce', { mode: 'number' }, { mode: "number" }).notNull(),
...
export const stakeRecords = pgTable('stake_records', {
  ...
  lastRewardClaim: varchar('last_reward_claim', { length: 20 }).notNull(),
